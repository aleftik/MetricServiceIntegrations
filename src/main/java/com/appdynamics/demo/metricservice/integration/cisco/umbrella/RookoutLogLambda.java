...
public class RookoutLogLambda implements RequestHandler<S3Event, String> {
    ...
    public String handleRequest(S3Event s3event, Context context) {
        ...
        for (S3EventNotification.S3EventNotificationRecord record:events) {
            ...
            List<RookoutLogLambda.UmbrellaLogRecord> records = processFile(file);
     ...
     */
    private void writeToLogStream(String functionName, String apiKey, List<RookoutLogLambda.UmbrellaLogRecord> records) {
        Socket socket = null;
        ...
        try {
            ...
            for (RookoutLogLambda.UmbrellaLogRecord record: records) {
     ...
     */
    private JsonObject toJson(String functionName, RookoutLogLambda.UmbrellaLogRecord record) {
     ...
     */
    private List<RookoutLogLambda.UmbrellaLogRecord> processFile(S3Object file) {
        List<RookoutLogLambda.UmbrellaLogRecord> records = new ArrayList<RookoutLogLambda.UmbrellaLogRecord>();
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                RookoutLogLambda.UmbrellaLogRecord logRecord = toUmbrellaRecord(record);
     ...
     */
    private RookoutLogLambda.UmbrellaLogRecord toUmbrellaRecord(CSVRecord record){
        RookoutLogLambda.UmbrellaLogRecord item = new RookoutLogLambda.UmbrellaLogRecord();
