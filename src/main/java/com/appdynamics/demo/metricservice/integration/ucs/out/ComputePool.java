 ...
 *         &lt;element ref="{}computePooledRackUnit"/>
 *         &lt;element ref="{}computePooledSlot"/>
...
public class ComputePool {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "computePooledRackUnit", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "faultInst", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "computePooledSlot", type = JAXBElement.class, required = false)
    })
    @XmlMixed
