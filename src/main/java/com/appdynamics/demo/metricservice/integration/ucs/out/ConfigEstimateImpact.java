...
/**
 * <p>Java class for configEstimateImpact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="configEstimateImpact">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;all>
 *         &lt;element name="outAckables" type="{}configMap" minOccurs="0"/>
 *         &lt;element name="outOldAckables" type="{}configMap" minOccurs="0"/>
 *         &lt;element name="outAffected" type="{}configMap" minOccurs="0"/>
 *         &lt;element name="outOldAffected" type="{}configMap" minOccurs="0"/>
 *       &lt;/all>
...
@XmlType(name = "configEstimateImpact", propOrder = {
    "content"
})
public class ConfigEstimateImpact {

    @XmlElementRefs({
        @XmlElementRef(name = "outOldAckables", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "outOldAffected", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "outAckables", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "outAffected", type = JAXBElement.class, required = false)
    })
    @XmlMixed
